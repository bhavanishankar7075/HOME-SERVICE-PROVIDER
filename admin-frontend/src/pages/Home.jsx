    ...
    <Box className="home-container">
      <Box className="home-header">
        ...
        <Typography variant="h6" className="home-subtitle">
          Empowering Efficient Management of Services and Orders
        </Typography>
      </Box>
      <Grid container spacing={4} className="home-sections">
        <Grid item xs={12} md={4}>
          <Box className="home-section">
            ...
            <Typography className="section-text">
              Manage bookings, services, and feedback with ease using our intuitive interface.
            </Typography>
          </Box>
        </Grid>
        <Grid item xs={12} md={4}>
          <Box className="home-section">
            ...
            <Typography className="section-text">
              Track revenue and performance metrics in real-time for better decision-making.
            </Typography>
          </Box>
        </Grid>
        <Grid item xs={12} md={4}>
          <Box className="home-section">
            ...
            <Typography className="section-text">
              Login or signup to access a secure admin dashboard tailored for your needs.
            </Typography>
          </Box>
        </Grid>
      </Grid>
