...
import { Refresh, Logout, Menu, Dashboard as DashboardIcon, People as PeopleIcon, EventAvailable as EventAvailableIcon, Build as BuildIcon, Feedback as FeedbackIcon, ContactPhone as ContactPhoneIcon, Description as DescriptionIcon, ArrowBack, Settings as SettingsIcon, Mail as MailIcon, ContactMail as ContactMailIcon, LockReset as LockResetIcon, Chat as ChatIcon, Payments as PaymentsIcon } from '@mui/icons-material';
import { useNavigate } from 'react-router-dom';
import { useSelector, useDispatch } from 'react-redux';
...
const AdminDashboard = () => {
  ...
  const fetchData = useCallback(async () => {
    ...
    try {
      ...
      const [
        ...
        axios.get(`${API_URL}/api/dashboard/services/category-stats`, config).catch(err => {
          console.error('Error fetching category stats:', err.response?.data || err.message);
          return { data: {} };
        }),
        axios.get(`${API_URL}/api/dashboard/bookings/monthly-revenue`, config).catch(err => {
  ...
  const SidebarList = () => (
    <List>
      <ListItem button sx={{ cursor: 'pointer' }} onClick={() => navigate('/admin/dashboard')}><ListItemIcon sx={{ color: '#fff' }}><DashboardIcon /></ListItemIcon><ListItemText primary="Dashboard" sx={{color: 'white'}}/></ListItem>
      <ListItem 
        button 
        sx={{ cursor: 'pointer' }} 
        onClick={() => {
      ...
      <ListItem button sx={{ cursor: 'pointer' }} onClick={() => navigate('/admin/services')}><ListItemIcon sx={{ color: '#fff' }}><BuildIcon /></ListItemIcon><ListItemText primary="Services" sx={{color: 'white'}}/></ListItem>
      <ListItem button sx={{ cursor: 'pointer' }} onClick={() => {
      ...
      <ListItem button sx={{ cursor: 'pointer' }} onClick={() => navigate('/admin/feedbacks')}><ListItemIcon sx={{ color: '#fff' }}><FeedbackIcon /></ListItemIcon><ListItemText primary="Feedbacks" sx={{color: 'white'}}/></ListItem>
      <ListItem button sx={{ cursor: 'pointer' }} onClick={() => navigate('/admin/providers')}><ListItemIcon sx={{ color: '#fff' }}><PeopleIcon /></ListItemIcon><ListItemText primary="Providers" sx={{color: 'white'}}/></ListItem>
      <ListItem button sx={{ cursor: 'pointer' }} onClick={() => navigate('/admin/customers')}><ListItemIcon sx={{ color: '#fff' }}><PeopleIcon /></ListItemIcon><ListItemText primary="Customers" sx={{color: 'white'}}/></ListItem>
      <ListItem button sx={{ cursor: 'pointer' }} onClick={() => navigate('/admin/logs')}><ListItemIcon sx={{ color: '#fff' }}><DescriptionIcon /></ListItemIcon><ListItemText primary="Activity Logs" sx={{color: 'white'}}/></ListItem>
      <ListItem button sx={{ cursor: 'pointer' }} onClick={() => navigate('/admin/chats')}><ListItemIcon sx={{ color: '#fff' }}><ChatIcon /></ListItemIcon><ListItemText primary="Chats" sx={{color: 'white'}}/></ListItem>
      <ListItem button sx={{ cursor: 'pointer' }} onClick={() => navigate('/admin/plans')}><ListItemIcon sx={{ color: '#fff' }}><PaymentsIcon /></ListItemIcon><ListItemText primary="Plans" sx={{color: 'white'}}/></ListItem>
      <ListItem button sx={{ cursor: 'pointer' }} onClick={() => navigate('/admin/reset/password')}><ListItemIcon sx={{ color: '#fff' }}><LockResetIcon /></ListItemIcon><ListItemText primary="Reset Password" sx={{color: 'white'}}/></ListItem>
      <ListItem button sx={{ cursor: 'pointer' }} onClick={() => setShowSettings(true)}><ListItemIcon sx={{ color: '#fff' }}><SettingsIcon /></ListItemIcon><ListItemText primary="Settings" sx={{color: 'white'}}/></ListItem>
