...
const Services = () => {
  const { services, loading, fetchServices, message, setMessage } =
  ...
  const fetchAvailability = useCallback(async (serviceId, date) => {
    ...
    try {
      const res = await axios.get(
        `${API_URL}/api/services/${serviceId}/availability?date=${date}`,
      );
  ...
  const handleOpenSchedule = (service) => {
    ...
    if (!service.isAvailable) {
      setMessage({
        open: true,
        text: "This service is currently unavailable. Please try again later.",
        severity: "warning",
      });
      return;
    }
    ...
    // 📅 Fetch slots only for available services
    fetchAvailability(service._id, today);
  };
  ...
  const whyChooseUs = [
    {
      ...
      description: "Our vetted experts ensure top-quality service.",
      icon: <VerifiedIcon sx={{ color: "#4F46E5" }} />,
    },
    {
      title: "Convenient Booking",
      description: "Schedule services at your preferred time.",
      icon: <ScheduleIcon sx={{ color: "#4F46E5" }} />,
    },
    {
      title: "Customer Satisfaction",
      description: "High ratings from thousands of happy customers.",
      icon: <StarIcon sx={{ color: "#4F46E5" }} />,
    },
    {
      title: "24/7 Support",
      description: "Our team is here to assist you anytime.",
      icon: <SupportIcon sx={{ color: "#4F46E5" }} />,
    },
  ];
  ...
  if (loading) {
    return (
      <LoadingScreen
        title="Our Services"
        message="Finding the best options for you..."
      />
    );
  }

  const proceedButtonText =
    paymentMethod === "Stripe" ? "Proceed to Payment" : "Confirm COD Booking";
  ...
  return (
    <Box sx={{ bgcolor: "#F9FAFB", minHeight: "100vh", pt: 8 }}>
      ...
      <Box
        component="main"
        sx={{ flexGrow: 1, px: { xs: 2, sm: 4, lg: 6 }, py: 6 }}
      >
        <Box
          component="section"
          sx={{ py: 4, bgcolor: "white", borderRadius: 4, boxShadow: 2, mb: 6 }}
        >
        ...
        <Box
          component="section"
          sx={{ py: 6, bgcolor: "white", borderRadius: 4, boxShadow: 2, mb: 6 }}
        >
          <Container maxWidth="lg">
            <Typography
              variant="h4"
            ...
            <Grid container spacing={4}>
              {filteredAndSortedServices.length > 0 ? (
                filteredAndSortedServices.slice(0, 6).map((service) => (
                      ...
                      <CardContent sx={{ flexGrow: 1, p: 2 }}>
                        ...
                        >
                          ...
                          <Tooltip title={service.category}>
                            <Avatar
                              sx={{ bgcolor: "#EFF6FF", width: 32, height: 32 }}
                            >
                      ...
                      >
                        ...
                        <Button
                          ...
                          sx={{
                            ...
                            cursor: service.isAvailable
                              ? "pointer"
                              : "not-allowed",
                          }}
                        >
                          {service.isAvailable ? "Schedule" : "Unavailable"}
                        </Button>
                      </CardActions>
                    </Card>
                  </Grid>
        ...
        >
          <Container maxWidth="lg">
            ...
            >
              Discover why thousands of customers trust us for their home
              service needs.
            </Typography>
            <Grid container spacing={4}>
              {whyChooseUs.map((item, index) => (
                <Grid item xs={12} sm={6} md={3} key={index}>
                  ...
                  >
                    <Box sx={{ fontSize: 40, mb: 2, color: "#4F46E5" }}>
                      {item.icon}
                    </Box>
                    <Typography
                      variant="h6"
          ...
          >
            ...
            {activeStep === 0 && (
              <Box>
                ...
                <Typography
                  variant="subtitle1"
                  sx={{ mt: 2, mb: 1, color: "#1F2937", fontSize: "0.9rem" }}
                >
                  Available Slots:
                </Typography>
                {isTimeFetching ? (
            ...
            {activeStep === 1 && (
              <Box>
                ...
                <Paper
                  variant="outlined"
                  sx={{ p: 2, mb: 2, borderRadius: 2, bgcolor: "#F9FAFB" }}
                >
                  ...
                  <Typography sx={{ mb: 1, fontSize: "0.9rem" }}>
                    <strong>Time:</strong> {scheduleData.time || "N/A"}
                  </Typography>
                </Paper>
                <Paper
                  variant="outlined"
                ...
                <FormControl component="fieldset" fullWidth>
                  ...
                  >
                    <FormControlLabel
                      value="Stripe"
                      control={
                        <Radio sx={{ "&.Mui-checked": { color: "#4338CA" } }} />
                      }
                      label={
            ...
            {activeStep === 2 && (
              <Box sx={{ minHeight: { lg: "400px" } }}>
                ...
                >
                  Please enter your payment details below to confirm the
                  booking.
                </Typography>
            ...
            {activeStep === 3 && (
              <Box sx={{ textAlign: "center", py: 4 }}>
                ...
                <Typography sx={{ color: "#6B7280", fontSize: "0.9rem" }}>
                  Your booking is successful and is awaiting provider
                  assignment. You will be notified shortly.
                </Typography>
              </Box>
            )}
          </DialogContent>
        ...
        <Dialog
          ...
          maxWidth="md"
          fullWidth
          sx={{ "& .MuiDialog-paper": { borderRadius: 4, maxHeight: "90vh" } }}
        >
          <DialogTitle
            sx={{
              bgcolor: "#4F46E5",
          ...
          <DialogContent
            sx={{ pt: 3, pb: 2, overflowY: "hidden", bgcolor: "#F9FAFB" }}
          >
            <Grid container spacing={3}>
              <Grid item xs={12} md={5}>
                <CardMedia
                  ...
                  onError={(e) => {
                    console.error(
                      `Image load error for ${selectedService?.name || "Service"}:`,
                      e.target.src,
                    );
                    e.target.src =
                      "https://via.placeholder.com/300x250?text=Service+Image";
                  }}
                />
              </Grid>
              <Grid item xs={12} md={7}>
                <Typography
                  variant="body1"
                  sx={{ color: "#1F2937", mb: 2, fontSize: "0.9rem" }}
                >
                  {selectedService?.description || "No description available."}
                </Typography>
                <Typography
                  variant="h6"
                  sx={{ color: "#4F46E5", mb: 1, fontSize: "1.1rem" }}
                >
                  ₹{selectedService?.price?.toLocaleString("en-IN") || "0"}
                </Typography>
                <Typography
                  variant="subtitle1"
                  sx={{ color: "#1F2937", mb: 1, fontSize: "0.9rem" }}
                >
                ...
                <Box sx={{ display: "flex", alignItems: "center", mb: 2 }}>
                  <Rating
                    name="read-only"
                    value={selectedService?.averageRating || 0}
                    readOnly
                    precision={0.1}
                    size="small"
                  />
                  <Typography
                    sx={{ ml: 1, color: "#6B7280", fontSize: "0.85rem" }}
                  >
                    ({(selectedService?.averageRating || 0).toFixed(1)}/5,{" "}
                    {selectedService?.feedbackCount || 0} reviews)
                  </Typography>
                </Box>
              </Grid>
            </Grid>
          ...
          >
            ...
            <Button
              ...
              onClick={() => {
                ...
                navigate(`/services/${selectedService?._id || ""}`);
              }}
              sx={{
                bgcolor: "#4F46E5",
                "&:hover": { bgcolor: "#4338CA" },
