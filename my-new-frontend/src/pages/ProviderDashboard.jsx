...
function ProviderDashboard() {
  ...
  }, [user, token, navigate, fetchData, dispatch, editOpen]);
  ...
  const detectLocation = async () => {
    ...
    try {
      ...
      if (response.data.status === 'OK' && response.data.results.length > 0) {
        ...
        // Add nearby city logic for Madhuravada and Visakhapatnam
        if (newLocation.details.city === 'Madhuravada' && !newLocation.details.street) {
          newLocation.details.street = 'Visakhapatnam';
        } else if (newLocation.details.city === 'Visakhapatnam' && !newLocation.details.street) {
          newLocation.details.street = 'Madhuravada';
        }
        ...
        console.log('After detectLocation, editData.location:', editData.location);
      } else {
      ...
      setLoading(false);
      console.log('Finished detectLocation, editData.location:', editData.location);
    }
  };
    ...
    <Box sx={{ maxWidth: '1200px', margin: 'auto', p: { xs: 2, md: 3 }, mt: 4 }}>
      ...
      <Dialog open={editOpen} onClose={() => setEditOpen(false)}>
        ...
        <DialogContent>
          ...
          />
          <Button variant="outlined" onClick={detectLocation} sx={{ mt: 2, mr: 1 }} disabled={loading}>
            Detect Location
          </Button>
          <Button variant="contained" component="label" sx={{ mt: 2 }}>
            Upload Profile Image
